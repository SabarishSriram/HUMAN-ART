    ...
    <div className='grid md:grid-cols-2 border-[5px] m-3 md:mx-14 md:py-6  border-black rounded-3xl mt-28'>
        ...
        <div className=' px-4 my-auto '>
            ...
            <div className='flex md:justify-start justify-center mt-4 mb-8'>
                <button className='bg-black text-white md:text-base font-bold text-base rounded-full border-[3px] border-black  py-3 md:ml-0 ml-2 w-36 md:w-40 hover:bg-[#E03327] hover:shadow-2xl duration-300 ease-in-out'> 🤓 Learn More</button>
                <button className='bg-[#FFD91A] text-black md:text-base font-bold text-base rounded-full border-[3px] border-[#BB7A00]  py-4 ml-2 w-36 md:w-40 hover:bg-[#ddff47] hover:shadow-2xl duration-300 ease-in-out'> 🤼 Wrestle Now!</button>
            </div>
